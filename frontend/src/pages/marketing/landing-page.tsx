            ...
            <div className="bg-[#18181B] font-sans text-white">
                ...
                <section className="h-screen bg-[#18181B] px-6 py-20 text-center">
                    ...
                    <p className="mx-auto mb-6 max-w-xl text-base text-[#cdcdcd] lg:text-xl">
                        Effortlessly integrate inventory, asset tracking, quoting, and invoicing for complete business clarity.
                    </p>
                    <form className="flex justify-center gap-2">
                        ...
                        />
                        <button className="rounded bg-[#9A6CC3] px-4 py-2 text-white">Try Free</button>
                    </form>
                </section>

                {/* Benefits Section */}
                <section className="h-screen bg-[#9A6CC3] px-6 py-16 text-[#18181B]">
                    <h2 className="mb-10 text-center text-4xl font-bold">Here’s how Zaventory can benefit your business</h2>
                    <div className="mx-auto max-w-5xl justify-center gap-6 md:flex-row">
                        <div className="mb-10 rounded bg-white p-6 text-black">
                            ...
                            <p>Talk to your customers across messaging, email, social media, and more.</p>
                        </div>
                        <div className="mb-10 rounded bg-white p-6 text-black">
                            <h3 className="mb-2 font-semibold">Support at scale</h3>
                            <p>Manage your support requests and grow your customer base efficiently.</p>
                        </div>
                        <div className="mb-10 rounded bg-white p-6 text-black">
                            <h3 className="mb-2 font-semibold">Automate workflows</h3>
                            <p>Boost team productivity by automating repetitive tasks and support tickets.</p>
                        </div>
                        <div className="mb-10 rounded bg-white p-6 text-black">
                            <h3 className="mb-2 font-semibold">Engage customers</h3>
                            <p>Talk to your customers across messaging, email, social media, and more.</p>
                ...
                <section className="px-6 py-20">
                    <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
                        <div>
                            <h2 className="mb-4 text-3xl font-bold">Increase company revenue up to 65%</h2>
                ...
                <section className="bg-gray-50 py-16 text-center">
                    ...
                    <p className="mb-8">Plug Zaventory into the tools your team already uses.</p>
                    <div className="flex flex-wrap justify-center gap-6">
                        {["HubSpot", "Zoom", "Zendesk", "Intercom", "Slack", "Asana"].map((app) => (
                            <div
                                key={app}
                ...
                <section className="mx-auto max-w-6xl px-6 py-16">
                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                        <div>
                            ...
                            <h3 className="font-semibold">How To Deliver a Successful Product Launch</h3>
                            <p className="text-sm text-gray-500">May 25, 2025 — 6 min read</p>
                        </div>
                        <div>
                            <div className="mb-4 h-40 bg-gray-100"></div>
                            <h3 className="font-semibold">What Makes an Authentic Employee Profile?</h3>
                ...
                <section className="bg-white px-6 py-20 text-center">
                    <h2 className="mb-6 text-2xl font-bold">Real-life results and revenue</h2>
                    <p className="mb-6 text-gray-700">$2.5M: Startup X used Zaventory and saw revenue jump in 3 months.</p>
                    <p className="mb-6 text-gray-700">43%: Service team efficiency boost from using our help desk.</p>

                    <h3 className="mt-12 mb-4 text-xl font-semibold">We love our Customers and They love us too</h3>
                    <div className="mx-auto mt-6 flex max-w-4xl flex-col justify-center gap-10 text-left md:flex-row">
                        {["Best thing we’ve decided...", "Zaventory made change easier...", "Perfect for small businesses..."].map((quote, i) => (
                            <blockquote
                                key={i}
                ...
                <section className="bg-[#9A6CC3] py-16 text-center text-white">
                    <h2 className="mb-4 text-3xl font-bold">Ready to supercharge your business?</h2>
                    <p className="mb-6">Start your free trial today and join 10,000+ customers using Zaventory.</p>
                    <a
                        href="/register"
